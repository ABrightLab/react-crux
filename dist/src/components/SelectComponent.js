...
let SelectComponent = class SelectComponent extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            isValueChanged: false, previousValue: this.props.currentModel
        };
    }
    render() {
        ...
        if (this.props.field.foreign) {
            ...
            if (!(0, lodash_1.isNil)(this.props.currentModel) && !((0, lodash_1.isObject)(this.props.currentModel) && (0, lodash_1.isEmpty)(this.props.currentModel))) {
                const foreignDoc = (0, lodash_1.find)(optionsData, (doc) => {
                    if (this.props.field.foreign.keys) {
                        return this.props.field.foreign.keys.every((key) => doc[key] === this.props.currentModel[key]);
                    }
        ...
        return React.createElement("div", null,
            ...
            React.createElement(react_bootstrap_1.DropdownButton, { bsSize: "small", style: { width: "auto" }, id: this.props.field.field + "_dropdown", title: foreignTitle, disabled: this.props.readonly },
                React.createElement(react_bootstrap_1.MenuItem, { onSelect: () => this.select(this.props.field, undefined) }, "-Select-"),
                (0, lodash_1.map)(optionsData, ((doc, index) => {
                    let eventKey = doc;
                    if (this.props.field.valueType === "object") {
                        eventKey = doc;
                    }
                    ...
                    return React.createElement(react_bootstrap_1.MenuItem, { onSelect: (eventKey) => {
                            this.select(this.props.field, eventKey);
                        }, key: index, eventKey: eventKey }, this.props.field.foreign.titleTransform ? this.props.field.foreign.titleTransform(doc) : doc[this.props.field.foreign.title]);
                }))));
    }
};
